...
import { createBoardAccessRoutes } from '@/routes/boards/access.routes.js';
import { createBoardMutationRoutes } from '@/routes/boards/mutations.routes.js';
import { createBoardManagementRoutes } from '@/routes/boards/management.routes.js';
import { createBoardMemberRoutes } from '@/routes/boards/members.routes.js';
import { createBoardInvitationRoutes } from '@/routes/boards/invitations.routes.js';
import { createBoardLinkSharingRoutes } from '@/routes/boards/link-sharing.routes.js';
