import { ACTIVE_BOARDS_KEY, CLIENT_LEASE_TTL_SECONDS, COLLAB_MODE_COOLDOWN_MS, VIEWER_SESSION_TTL_MS, boardClientLeaseKey, boardClientsKey, boardCollabModeUntilKey, boardLastActiveKey, boardViewerSessionsKey, clientMember } from '../board-state/keys.js';
import type Redis from 'ioredis';
import type { RuntimeMetrics } from '@/platform/observability/metrics.js';
import type { BoardSyncWriteMode } from '../board-state/types.js';
